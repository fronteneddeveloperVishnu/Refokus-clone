    ...
    <div className='w-full '>
      <div className='relative max-w-screen-xl mx-auto text-center'>
        ...
        <div className='absolute top-0 w-full h-full '>
          {
            image.map( (elem, index) => (elem.isActive && (<img key={index} className='w-60 absolute -translate-x-[50%] -translate-y-[50%] rounded-lg '  src={elem.url} style={{top:elem.top, left:elem.left}} alt="" />)))
          }
        </div>
      </div>
    </div>
